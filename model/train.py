...
def main():
    ...
    parser.add_argument('-m', '--model_path', default='./model.pth', metavar='', help='model file (output of training)')
    parser.add_argument('--epochs', default=60, type=int, metavar='', help='number of epochs') #50
    parser.add_argument('--lr', default=0.01, type=float, metavar='', help='learning rate') #0.005
    ...
    dataset = VisumData(args['data_path'], modality='all', transforms=get_transform(train=True))
    dataset_val = VisumData(args['data_path'], modality='all', transforms=get_transform(train=False))
